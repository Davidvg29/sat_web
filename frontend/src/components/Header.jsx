    ...
    return(
        <header className={cn("flex justify-between items-center w-full bg-white p-2 shadow-md", className)} {...props}>
            <div className="flex ml-3">
                <img src={logoSat} alt="SAT - Sociedad aguas del Tucumán" />
                <h2 className="text-sm md:text-xl lg:text-3xl font-bold m-3" style={{color:"var(--azul-sat"}}>Sociedad aguas del Tucumán</h2>
            </div>
